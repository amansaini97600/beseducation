...
export default function StudentDiplomaSearch() {
    ...
    const handleSearch = async () => {
        try {
            ...
            const res1 = await fetch(`https://beseducation.onrender.com/diplomas/search/${searchId}`);
            if (!res1.ok) throw new Error("Diploma not found");
            const diplomaData = await res1.json();

            const res2 = await fetch(`https://beseducation.onrender.com/diplomas/search/${searchId}/marks`);
