...
export default function StudentCertificateSearch() {
    ...
    const handleSearch = async () => {
        ...
        try {
            const res = await fetch(`https://beseducation-backend.onrender.com/api/certificates/search/${regNo}`);
            ...
            {!certificate ? (
                ...
                <div className="overflow-auto w-full">
                    ...
                    >
                        ...
                        {/* Student Photo */}
                        <img
                            src={`https://beseducation-backend.onrender.com/api${certificate.photo}`}
                            alt="Student"
