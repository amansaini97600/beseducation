...
export default function StudentList() {
  ...
  useEffect(() => {
    fetch("https://beseducation-backend.onrender.com/api/students", {
      headers: {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await fetch(`https://beseducation-backend.onrender.com/api/students/${id}`, {
        method: "DELETE",
        headers: {
          Authorization: `Bearer ${localStorage.getItem("adminToken")}`,
        },
  ...
  const handleSave = async (updated) => {
    try {
      await fetch(`https://beseducation-backend.onrender.com/api/students/${updated.id}`, {
        method: "PUT",
        headers: {
