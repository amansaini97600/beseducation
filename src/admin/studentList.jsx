...
export default function StudentList() {
  ...
  useEffect(() => {
    fetch("https://beseducation-backend.onrender.com/students", {
      headers: {
  ...
  const handleDelete = async (id) => {
    ...
    try {
      await fetch(`https://beseducation-backend.onrender.com/students/${id}`, {
        method: "DELETE",
        headers: {
          Authorization: `Bearer ${localStorage.getItem("adminToken")}`,
        },
  ...
  const handleSave = async (updated) => {
    try {
      await fetch(`https://beseducation-backend.onrender.com/students/${updated.id}`, {
        method: "PUT",
        headers: {
