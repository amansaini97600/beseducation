...
export default function EditDiploma() {
  ...
  useEffect(() => {
    const fetchDiploma = async () => {
      try {
        ...
        const res = await axios.get(`https://beseducation-backend.onrender.com/api/diplomas/${id}`, {
  ...
  const handleSubmit = async (e) => {
    ...
    const updatedData = {
      ...
      phone,
      aadhar,
      compilation_date: dateOfCompilation,
      generation_date: dateOfGeneration
    };
    ...
    try {
      const token = localStorage.getItem("adminToken");
      await axios.put(`https://beseducation-backend.onrender.com/api/diplomas/${id}`, updatedData, {
        headers: { Authorization: `Bearer ${token}` },
      });
